            ...
            <CardContent>
              <div className="space-y-3">
                {unbilledTime.map((entry) => (
                  <div key={entry.id} className="flex items-center gap-3 p-3 rounded-lg bg-card/50">
                    <Checkbox
            ...
            <CardContent>
              <div className="space-y-3">
                {unbilledExpenses.map((expense) => (
                  <div key={expense.id} className="flex items-center gap-3 p-3 rounded-lg bg-card/50">
                    <Checkbox
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <Input
                    ...
                    className="w-20 h-8 bg-card/50 border-border"
                  />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <Select value={discountType} onValueChange={setDiscountType}>
                    <SelectTrigger className="w-20 h-8 bg-card/50 border-border">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
