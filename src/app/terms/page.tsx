  ...
  return (
    <div className="min-h-screen bg-slate-950">
      <div className="container mx-auto max-w-4xl py-12 px-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-3xl text-white">Terms and Conditions</CardTitle>
          ...
          <CardContent className="prose prose-invert max-w-none space-y-6 text-slate-300">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">5. Legal Practice</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">6. Subscription and Billing</h2>
              <p>
